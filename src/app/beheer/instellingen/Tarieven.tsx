    ...
    >
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        <div>
          ...
          <p className="mt-1 text-xs text-neutral-500">In euro per gewerkt uur.</p>
        </div>
        <div>
          ...
          <p className="mt-1 text-xs text-neutral-500">Een kortere dag wordt hiermee aangevuld.</p>
        </div>
        <div>
          ...
          <p className="mt-1 text-xs text-neutral-500">Per kilometer. Wordt heen en terug gerekend.</p>
        </div>
        <div>
          ...
          <p className="mt-1 text-xs text-neutral-500">In minuten enkele reis. Standaard 90.</p>
        </div>
        <div>
          ...
          <p className="mt-1 text-xs text-neutral-500">0,5 betekent het halve uurtarief.</p>
        </div>
      </div>
